    ...
    <div>
      ...
      >
        <div data-aos="fade-up" data-aos-delay="0" className="container mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-12 pt-10  items-center container mx-auto px-6 md:px-12  lg:gap-20 ">
            ...
            <div className=" text-gray-600">         
                 <div className="text-center text-2xl sm:text-3xl font-bold mb-3">Tenaga Kerja Outsourcing
                  </div><p className="text-xl text-center">Tenaga kerja dari pihak ketiga
        ...
        <div data-aos="fade-up" data-aos-delay="0" className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 text-left leading-tight items-center container mx-auto px-6 md:px-12  md:flex-row  lg:gap-20 ">
            <div className=" ">
              
              <p className="text-xl">
               <span className="text-xl font-bold"> Undang-Undang No. 13 Th. 2003 tentang Ketenagakerjaan (UU
                Ketenagakerjaan) : </span><span className="text-gray-600">Sebelum UU Cipta Kerja, outsourcing diatur
              ...
              <p className="text-xl">
                ...
                Menjadi Undang-Undang :</span> <span className="text-gray-600">UU ini mengubah dan memperbarui
                ketentuan mengenai outsourcing dalam UU Ketenagakerjaan,
                mengizinkan penyerahan sebagian pekerjaan kepada pihak lain
                dengan perjanjian tertulis.</span>
              </p><br />
              <p className="text-xl">
